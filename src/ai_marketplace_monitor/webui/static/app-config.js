...
(() => {
  ...
  const FORM_SCHEMAS = {
    ...
    "user.*": [
      { key: "app_url", label: "App address", type: "text", group: "Links",
        help: "Public address of this web UI, e.g. https://aimm.example.com; used for links in notifications. Each notification then carries an Open in AIMM button that opens that listing's detail here." },
      { key: "pushbullet_token", label: "Pushbullet token", type: "password", group: "Pushbullet", help: "Get your token from pushbullet.com → Settings → Access tokens." },
      ...
      { key: "ntfy_token", label: "ntfy access token", type: "password", help: "Needed only when the server refuses anonymous publishing. Sent as an Authorization: Bearer header." },
