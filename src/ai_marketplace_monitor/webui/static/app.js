  ...
  const FORM_SCHEMAS = {
    ...
    "marketplace.ebay": [
      ...
      { key: "max_listings", label: "Max listings per search phrase", type: "number", column: "left",
        help: "How many results one search phrase may hand to the AI. Default: 60. Every listing that comes back costs one AI rating — about 25 seconds on a local Ollama — so a phrase that returns 240 tiles is an hour of rating for that phrase alone. Four uncapped phrases is how one car search spent five hours rating car parts." },
    ...
    "marketplace.depop": [
      ...
      { key: "max_listings", label: "Max listings per search phrase", type: "number", column: "left",
        help: "How many results one search phrase may hand to the AI. Default: 60. Every listing that comes back costs one AI rating — about 25 seconds on a local Ollama — so a phrase that returns 240 tiles is an hour of rating for that phrase alone." },
